...
You must have Node.js installed on your computer. On the directory root, please run `npm install` then `ng serve --open`, and the project will open on your default browser. You can perform the unit tests with Jusmine by running `ng test`. 
